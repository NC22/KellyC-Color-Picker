...
t=a.input):"object"===typeof a.input&&(t=a.input);void 0!==a.changeCursor&&(sa=a.changeCursor);void 0!==a.alpha&&(F=a.alpha);void 0!==a.alphaSlider&&(C=a.alphaSlider);void 0!==a.inputColor&&(na=a.inputColor);void 0!==a.inputFormat&&(aa=a.inputFormat);a.userEvents&&(l=a.userEvents);a.place&&"object"!==typeof a.place&&(c=a.place,a.place=document.getElementById(a.place));a.place?D=a.place:t?(p.tag=document.createElement("div"),p.tag.className="popup-kelly-color",a.popupClass?p.tag.className=a.popupClass:
