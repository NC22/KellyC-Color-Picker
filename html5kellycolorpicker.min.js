...
360+a);m.h=a/360;F=U(m.h,m.s,m.v);I=da(F);fa();l.change&&(0,l.change)(g);W();L=!1;M()};this.setColorForColorSaver=function(a,b){var c=N(a,!0);if(c){var d=g.getColorSaver(b);d.selected?this.setColorByHex(a,!1):(d.color=c.h,M());return!0}};this.setColor=function(a,b){g.setColorByHex(a,b)};this.setColorByHex=function(a,b){b||(b=!1);var c=G;if(!1!==a){if(!a||!a.length)return;var d=N(a,!0);if(!d)return;a=d.h;D&&(c=d.a)}else a=I;D&&a==I&&L&&c!=G?(G=c,M()):I&&a==I&&L||(G=c,F=Y(a),I=a,m=la(F),c=y.svToDot(m),
m.x=c.x,m.y=c.y,L=!1,fa(),M(),l.change&&(0,l.change)(g),W(b))};this.setAlphaByDot=function(a){G=r.dotToAlpha(a);l.change&&(0,l.change)(g);W();M()};this.setAlpha=function(a){G=a;W();M()};this.setColorByDot=function(a){var b=y.dotToSv(a);m.s=b.s;m.v=b.v;m.x=a.x;m.y=a.y;1<m.s&&(m.s=1);0>m.s&&(m.s=0);1<m.v&&(m.v=1);0>m.v&&(m.v=0);F=U(m.h,m.s,m.v);I=da(F);fa();l.change&&(0,l.change)(g);W();M()};this.mouseOutEvent=function(a){0<C.curType&&!KellyColorPicker.cursorLock&&C.initStandartCursor()};this.mouseMoveRest=
function(a){if(!A&&K){K=!1;var b=Q(a);C.updateCursor(b);requestAnimationFrame(function(){K=!0});l.mousemoverest&&(0,l.mousemoverest)(a,g,b)}};this.touchMoveEvent=function(a){A&&event.preventDefault()};this.mouseDownEvent=function(a){a.preventDefault();var b,c=!1,d=Q(a);if(h.isDotIn(d))A="wheel",g.setHueByDot(d),b=function(a){g.wheelMouseMove(a,d)},c=function(a){KellyColorPicker.cursorLock=!1;g.wheelMouseUp(a,d)};else if(y.isDotIn(d))A="sv",g.setColorByDot(d),b=function(a){g.svMouseMove(a,d)},c=function(a){KellyColorPicker.cursorLock=
!1;g.svMouseUp(a,d)};else if(D&&r.isDotIn(d))A="alpha",g.setAlphaByDot(d),b=function(a){g.alphaMouseMove(a,d)},c=function(a){KellyColorPicker.cursorLock=!1;g.alphaMouseUp(a,d)};else if(w&&w.isDotIn(d))g.setMethod();else if(k.length)for(a=0;a<=k.length-1;++a)if(k[a].isDotIn(d)){pa(a);break}b&&c&&(oa(),KellyColorPicker.cursorLock=g,z(document,"mouseup",c,"action_process_"),z(document,"mousemove",b,"action_process_"),z(document,"touchend",c,"action_process_"),z(document,"touchmove",b,"action_process_"))};
this.wheelMouseMove=function(a,b){a.preventDefault();if(A&&K){K=!1;var c=Q(a);requestAnimationFrame(function(){K=!0});g.setHueByDot(c);l.mousemoveh&&(0,l.mousemoveh)(a,g,c)}};this.wheelMouseUp=function(a,b){a.preventDefault();if(A){q(document,"mouseup","action_process_");q(document,"mousemove","action_process_");q(document,"touchend","action_process_");q(document,"touchmove","action_process_");ba();L=A=!1;M();var c=Q(a);C.updateCursor(c);l.mouseuph&&(0,l.mouseuph)(a,g,c)}};this.alphaMouseMove=function(a,
b){a.preventDefault();if(A&&K){K=!1;var c=Q(a),c=r.limitDotPosition(c);requestAnimationFrame(function(){K=!0});g.setAlphaByDot(c);l.mousemovealpha&&(0,l.mousemovealpha)(a,g,c)}};this.alphaMouseUp=function(a,b){a.preventDefault();if(A){q(document,"mouseup","action_process_");q(document,"mousemove","action_process_");q(document,"touchend","action_process_");q(document,"touchmove","action_process_");ba();A=!1;var c=Q(a);C.updateCursor(c);l.mouseupalpha&&(0,l.mouseupalpha)(a,g,c)}};this.svMouseMove=function(a,
b){a.preventDefault();if(A&&K){K=!1;var c=Q(a),c=y.limitDotPosition(c);requestAnimationFrame(function(){K=!0});g.setColorByDot(c);l.mousemovesv&&(0,l.mousemovesv)(a,g,c)}};this.svMouseUp=function(a,b){a.preventDefault();if(A){q(document,"mouseup","action_process_");q(document,"mousemove","action_process_");q(document,"touchend","action_process_");q(document,"touchmove","action_process_");ba();A=!1;var c=Q(a);C.updateCursor(c);D&&(L=!1,M());l.mouseupsv&&(0,l.mouseupsv)(a,g,c)}};this.addUserEvent=function(a,
b){l[a]=b;return!0};this.removeUserEvent=function(a){if(!l[a])return!1;l[a]=null;return!0};this.getCanvas=function(){return e?n:!1};this.getCtx=function(){return e?e:!1};this.getInput=function(){return t};this.getSvFig=function(){return y};this.getSvFigCursor=function(){return ra};this.getWheel=function(){return h};this.getWheelCursor=function(){return x};this.getCurColorHsv=function(){return m};this.getCurColorRgb=function(){return F};this.getCurColorHex=function(){return I};this.getCurColorRgba=
function(){return{r:F.r,g:F.g,b:F.b,a:G}};this.getCurAlpha=function(){return G};this.getAlphaFig=function(){return D?r:!1};this.getPopup=function(){return p};this.getSize=function(){return u};this.getColorSaver=function(a){for(var b=0;b<=k.length-1;++b)if(!a&&k[b].selected||k[b].align==a)return k[b].rgb=Y(k[b].color),k[b].hsv=la(k[b].rgb.r,k[b].rgb.g,k[b].rgb.b),k[b]};this.setColorSaver=function(a){if(!a)return!1;for(var b=0;b<=k.length-1;++b)if(k[b].align==a)return pa(b),k[b]};this.updateView=function(a){if(!e)return!1;
