...
(b={x:0,y:0});a=180*Math.atan2(a.y-b.y,a.x-b.x)/I;c&&0>a&&(a=360+a);return a}function X(){ba=2+u.paddingX;H=!1;e.imageData=null;A=w/2;e.pos={x:A,y:A};e.outerRadius=A-ba;e.innerRadius=e.outerRadius-e.width;u.path=[{x:e.innerRadius-u.paddingX,y:-1*u.height},{x:e.outerRadius+u.paddingX,y:-1*u.height},{x:e.outerRadius+u.paddingX,y:u.height},{x:e.innerRadius-u.paddingX,y:u.height},{x:e.innerRadius-u.paddingX,y:-1*u.height}];var a=w;D&&(a+=n.width+2*n.padding);"CANVAS"!=y.tagName&&(y.style.width=a+"px",
y.style.height=w+"px");q.width=a;q.height=w;x.updateSize();D&&n.updateSize()}function P(a){if(l)if(p.updateinput)(0,p.updateinput)(f,l,a);else{var b="rgba("+t.r+", "+t.g+", "+t.b+", "+z.toFixed(2)+")";a||(l.value=1>z&&"mixed"===S?b:"hex"===S||"mixed"===S?E:b);ca&&(l.style.color=.5>k.v?"#FFF":"#000",l.style.background=b)}}function fa(){if(!y)return!1;"CANVAS"!=y.tagName?(q=document.createElement("CANVAS"),y.appendChild(q)):q=y;"undefined"!=typeof window.G_vmlCanvasManager&&(q=window.G_vmlCanvasManager.initElement(q),
C=window.G_vmlCanvasManager.initElement(C));return q.getContext&&q.getContext("2d")?(b=q.getContext("2d"),G=C.getContext("2d"),!0):!1}function T(){r(q,"mousedown",function(a){f.mouseDownEvent(a)},"wait_action_");r(q,"touchstart",function(a){f.mouseDownEvent(a)},"wait_action_");r(q,"mouseout",function(a){f.mouseOutEvent(a)},"wait_action_");r(window,"touchmove",function(a){f.touchMoveEvent(a)},"wait_action_");r(q,"mousemove",function(a){f.mouseMoveRest(a)},"wait_action_")}function da(){m(q,"mousedown",
"wait_action_");m(q,"touchstart","wait_action_");m(q,"mouseout","wait_action_");m(window,"touchmove","wait_action_");m(q,"mousemove","wait_action_")}function K(a){a=a||window.event;var b,c=document.body.scrollLeft+document.documentElement.scrollLeft,d=document.body.scrollTop+document.documentElement.scrollTop;a.touches?(b=a.touches[0].clientX+c,a=a.touches[0].clientY+d):(b=a.clientX+c,a=a.clientY+d);var e=q.getBoundingClientRect();b-=e.left+c;a-=e.top+d;return{x:b,y:a}}function ga(){if(!b)return!1;
b.clearRect(0,0,q.width,q.height);if(H)return b.putImageData(Q,0,0),D&&n.draw(),!0;e.draw();x.draw();D&&n.draw();v||(Q=b.getImageData(0,0,w,w),H=!0);return!0}function L(){if(!ga())return!1;var a=360*k.h-e.startAngle;D&&(b.beginPath(),b.rect(n.pos.x-2,n.padding+n.height*(1-z)-1,n.width+4,2),b.strokeStyle="rgba(0,0,0, 0.8)",b.lineWidth=2,b.stroke(),b.closePath());b.beginPath();var h=u.path,c;c=I/180*a;for(var a=[],d=0;d<=h.length-1;++d)a[d]={x:h[d].x*Math.cos(c)-h[d].y*Math.sin(c),y:h[d].x*Math.sin(c)+
h[d].y*Math.cos(c)};for(h=0;h<=a.length-1;++h)a[h].x+=e.pos.x,a[h].y+=e.pos.y,0==h?b.moveTo(a[h].x,a[h].y):b.lineTo(a[h].x,a[h].y);b.strokeStyle="rgba(0,0,0,0.8)";b.lineWidth=u.lineWeight;b.stroke();b.closePath();b.strokeStyle=.5<k.v&&.5>k.s?"rgba(0, 0, 0, 1)":"rgba(255, 255, 255, 1)";b.beginPath();b.lineWidth=2;b.arc(k.x,k.y,ea.radius,0,2*I);b.stroke();b.closePath();return!1}var I=Math.PI,x,ea={radius:4},q=!1,b=!1,Y="quad",D=!1,v=!1,B=!0,J=[],p=[],C=document.createElement("canvas"),G=!1,H=!1,Q=null,
l=!1,ca=!0,S="mixed",g={tag:!1,margin:6},y=!1,f=this,ba,w=200,A,k,t,E="#000000",z=1,e={width:18,imageData:null};e.innerRadius;e.startAngle=0;e.outerRadius;e.outerStrokeStyle="rgba(0,0,0,0.2)";e.innerStrokeStyle="rgba(0,0,0,0.2)";e.pos;e.draw=function(){if(this.imageData)b.putImageData(this.imageData,0,0);else{for(var a=this.startAngle,h=0;360>=h;h++){var c=I/180*(h-2),d=I/180*h;b.beginPath();b.moveTo(A,A);b.arc(A,A,this.outerRadius,c,d,!1);b.closePath();c=N(a/360,1,1);b.fillStyle="rgb("+c.r+", "+
c.g+", "+c.b+")";b.fill();a++;360<=a&&(a=0)}b.globalCompositeOperation="destination-out";b.beginPath();b.arc(A,A,this.innerRadius,0,2*I);b.fill();b.globalCompositeOperation="source-over";b.strokeStyle=this.innerStrokeStyle;b.lineWidth=2;b.stroke();b.closePath();b.beginPath();b.arc(A,A,this.outerRadius,0,2*I);b.strokeStyle=this.outerStrokeStyle;b.lineWidth=2;b.stroke();b.closePath();this.imageData=b.getImageData(0,0,w,w)}};e.isDotIn=function(a){return Math.pow(e.pos.x-a.x,2)+Math.pow(e.pos.y-a.y,2)<
Math.pow(e.outerRadius,2)&&Math.pow(e.pos.x-a.x,2)+Math.pow(e.pos.y-a.y,2)>Math.pow(e.innerRadius,2)?!0:!1};var u={lineWeight:2,height:4,paddingX:2};u.path;var n={width:18,padding:4,outerStrokeStyle:"rgba(0,0,0,0.2)",innerStrokeStyle:"rgba(0,0,0,0.2)"};n.height;n.pos;n.updateSize=function(){this.pos={x:w+n.padding,y:n.padding};this.height=w-2*n.padding};n.draw=function(){var a=b.createLinearGradient(0,0,0,this.height);a.addColorStop(0,"rgba("+t.r+","+t.g+","+t.b+",1)");a.addColorStop(1,"rgba("+t.r+
","+t.g+","+t.b+",0)");b.beginPath();b.rect(this.pos.x,this.pos.y,this.width,this.height);b.fillStyle="white";b.fill();b.fillStyle=a;b.fill();b.strokeStyle="rgba(0,0,0, 0.2)";b.lineWidth=2;b.stroke();b.closePath()};n.dotToAlpha=function(a){return 1-Math.abs(this.pos.y-a.y)/this.height};n.alphaToDot=function(a){return{x:0,y:this.height-this.height*a}};n.limitDotPosition=function(a){a=a.y;a<this.pos.y&&(a=this.pos.y);a>this.pos.y+this.height&&(a=this.pos.y+this.height);return{x:this.pos.x,y:a}};n.isDotIn=
function(a){return a.x<this.pos.x||a.x>this.pos.x+n.width||a.y<this.pos.y||a.y>this.pos.y+this.height?!1:!0};var F={svCursorData:null,stCursor:null,curType:0,size:16,initSvCursor:function(){if(!q)return!1;var a=document.body;this.curType=1;this.stCursor||(this.stCursor=a.style.cursor);this.stCursor||(this.stCursor="auto");if(this.svCursorData)return a.style.cursor=this.svCursorData,!0;if(!C)return!1;var b=this.size+2;C.width=b;C.height=b;G.clearRect(0,0,this.size,this.size);G.strokeStyle="rgba(255, 255, 255, 1)";
...
F.initStandartCursor())}};this.popUpClose=function(a){if(!1!==g.tag){if(a&&(a.target==l||a.target==q||a.target==g.tag))return!1;g.tag.style.display="none";KellyColorPicker.activePopUp==f&&(KellyColorPicker.activePopUp=!1)}};this.popUpShow=function(a){if(!1!==g.tag){KellyColorPicker.popupEventsInclude||(r(document,"click",function(a){return KellyColorPicker.activePopUp?KellyColorPicker.activePopUp.popUpClose(a):!1},"popup_close_"),r(window,"resize",function(a){if(KellyColorPicker.activePopUp)return KellyColorPicker.activePopUp.popUpShow(a)},
...
d+"px";g.tag.style.display="block";KellyColorPicker.activePopUp=f;return!1}};this.setHueByDot=function(a){a=Z(a,e.pos)+e.startAngle;0>a&&(a=360+a);k.h=a/360;t=N(k.h,k.s,k.v);E=W(t);p.change&&(0,p.change)(f);P();H=!1;L()};this.setColorByHex=function(a,b){b||(b=!1);var c=z;if(!1!==a){if(!a||!a.length)return;var d=M(a,!0);if(!d)return;a=d.h;D&&(c=d.a)}else a=E;if(D&&a==E&&H&&c!=z)z=c,L();else if(!E||a!=E||!H){z=c;c=a;c=parseInt("#"==c.charAt(0)?c.slice(1):c,16);t={r:c>>16,g:c>>8&255,b:c&255};E=a;var c=
t,e=d=void 0;c&&void 0===d&&void 0===e&&(d=c.g,e=c.b,c=c.r);var c=c/255,d=d/255,e=e/255,g=Math.max(c,d,e),m=Math.min(c,d,e),l,n=g-m;if(g==m)l=0;else{switch(g){case c:l=(d-e)/n+(d<e?6:0);break;case d:l=(e-c)/n+2;break;case e:l=(c-d)/n+4}l/=6}k={h:l,s:0==g?0:n/g,v:g};l=x.svToDot(k);k.x=l.x;k.y=l.y;H=!1;L();p.change&&(0,p.change)(f);P(b)}};this.setAlphaByDot=function(a){z=n.dotToAlpha(a);p.change&&(0,p.change)(f);P();L()};this.setAlpha=function(a){z=a;P();L()};this.setColorByDot=function(a){var b=x.dotToSv(a);
k.s=b.s;k.v=b.v;k.x=a.x;k.y=a.y;1<k.s&&(k.s=1);0>k.s&&(k.s=0);1<k.v&&(k.v=1);0>k.v&&(k.v=0);t=N(k.h,k.s,k.v);E=W(t);p.change&&(0,p.change)(f);P();L()};this.mouseOutEvent=function(a){0<F.curType&&!KellyColorPicker.cursorLock&&F.initStandartCursor()};this.mouseMoveRest=function(a){if(!v&&B){B=!1;var b=K(a);F.updateCursor(b);requestAnimationFrame(function(){B=!0});p.mousemoverest&&(0,p.mousemoverest)(a,f,b)}};this.touchMoveEvent=function(a){v&&event.preventDefault()};this.mouseDownEvent=function(a){a.preventDefault();
var b,c=!1,d=K(a);e.isDotIn(d)?(v="wheel",f.setHueByDot(d),b=function(a){f.wheelMouseMove(a,d)},c=function(a){KellyColorPicker.cursorLock=!1;f.wheelMouseUp(a,d)}):x.isDotIn(d)?(v="sv",f.setColorByDot(d),b=function(a){f.svMouseMove(a,d)},c=function(a){KellyColorPicker.cursorLock=!1;f.svMouseUp(a,d)}):D&&n.isDotIn(d)&&(v="alpha",f.setAlphaByDot(d),b=function(a){f.alphaMouseMove(a,d)},c=function(a){KellyColorPicker.cursorLock=!1;f.alphaMouseUp(a,d)});b&&c&&(da(),KellyColorPicker.cursorLock=f,r(document,
"mouseup",c,"action_process_"),r(document,"mousemove",b,"action_process_"),r(document,"touchend",c,"action_process_"),r(document,"touchmove",b,"action_process_"))};this.wheelMouseMove=function(a,b){a.preventDefault();if(v&&B){B=!1;var c=K(a);requestAnimationFrame(function(){B=!0});f.setHueByDot(c);p.mousemoveh&&(0,p.mousemoveh)(a,f,c)}};this.wheelMouseUp=function(a,b){a.preventDefault();if(v){m(document,"mouseup","action_process_");m(document,"mousemove","action_process_");m(document,"touchend","action_process_");
m(document,"touchmove","action_process_");T();H=v=!1;L();var c=K(a);F.updateCursor(c);p.mouseuph&&(0,p.mouseuph)(a,f,c)}};this.alphaMouseMove=function(a,b){a.preventDefault();if(v&&B){B=!1;var c=K(a),c=n.limitDotPosition(c);requestAnimationFrame(function(){B=!0});f.setAlphaByDot(c);p.mousemovealpha&&(0,p.mousemovealpha)(a,f,c)}};this.alphaMouseUp=function(a,b){a.preventDefault();if(v){m(document,"mouseup","action_process_");m(document,"mousemove","action_process_");m(document,"touchend","action_process_");
m(document,"touchmove","action_process_");T();v=!1;var c=K(a);F.updateCursor(c);p.mouseupalpha&&(0,p.mouseupalpha)(a,f,c)}};this.svMouseMove=function(a,b){a.preventDefault();if(v&&B){B=!1;var c=K(a),c=x.limitDotPosition(c);requestAnimationFrame(function(){B=!0});f.setColorByDot(c);p.mousemovesv&&(0,p.mousemovesv)(a,f,c)}};this.svMouseUp=function(a,b){a.preventDefault();if(v){m(document,"mouseup","action_process_");m(document,"mousemove","action_process_");m(document,"touchend","action_process_");
m(document,"touchmove","action_process_");T();v=!1;var c=K(a);F.updateCursor(c);p.mouseupsv&&(0,p.mouseupsv)(a,f,c)}};this.addUserEvent=function(a,b){p[a]=b;return!0};this.removeUserEvent=function(a){if(!p[a])return!1;p[a]=null;return!0};this.getCanvas=function(){return b?q:!1};this.getCtx=function(){return b?b:!1};this.getInput=function(){return l};this.getSvFig=function(){return x};this.getSvFigCursor=function(){return ea};this.getWheel=function(){return e};this.getWheelCursor=function(){return u};
this.getCurColorHsv=function(){return k};this.getCurColorRgb=function(){return t};this.getCurColorHex=function(){return E};this.getCurColorRgba=function(){return{r:t.r,g:t.g,b:t.b,a:z}};this.getCurAlpha=function(){return z};this.getAlphaFig=function(){return D?n:!1};this.getPopup=function(){return g};this.getSize=function(){return w};this.updateView=function(a){if(!b)return!1;a&&(e.imageData=null,Q=x.imageData=null);H=!1;X();L();return!0};this.resize=function(a){if(!b)return!1;if(a==w)return!0;H=
!1;e.imageData=null;Q=x.imageData=null;w=a;X();f.setColorByHex(!1);return!1};this.destroy=function(){0<F.curType&&(KellyColorPicker.cursorLock=!1,F.initStandartCursor());v&&(m(document,"mouseup","action_process_"),m(document,"mousemove","action_process_"),m(document,"touchend","action_process_"),m(document,"touchmove","action_process_"),v=!1);g.tag&&m(l,"click","popup_");l&&(m(l,"click","input_edit_"),m(l,"change","input_edit_"),m(l,"keyup","input_edit_"),m(l,"keypress","input_edit_"));KellyColorPicker.popupEventsInclude&&
J.popup_close_click&&(KellyColorPicker.activePopUp&&KellyColorPicker.activePopUp.popUpClose(!1),m(document,"click","popup_close_"),m(window,"resize","popup_resize_"),KellyColorPicker.popupEventsInclude=!1);e.imageData=null;C=Q=x.imageData=null;y&&y.parentNode&&y.parentNode.removeChild(y);da();f=null};(function(a){var b="",c="";a.input&&"object"!==typeof a.input?(a.input=document.getElementById(a.input),l=a.input):"object"===typeof a.input&&(l=a.input);void 0!==a.alpha&&(z=a.alpha);void 0!==a.alpha_slider&&
(D=a.alpha_slider);void 0!==a.input_color&&(ca=a.input_color);void 0!==a.input_format&&(S=a.input_format);a.userEvents&&(p=a.userEvents);a.place&&"object"!==typeof a.place&&(c=a.place,a.place=document.getElementById(a.place));a.place?y=a.place:l?(g.tag=document.createElement("div"),g.tag.className="popup-kelly-color",a.popupClass?g.tag.className=a.inputClassName:(g.tag.className="popup-kelly-color",g.tag.style.position="absolute",g.tag.style.bottom="0px",g.tag.style.left="0px",g.tag.style.display=
"none",g.tag.style.backgroundColor="#e1e1e1",g.tag.style.border="1px solid #bfbfbf",g.tag.style.boxShadow="7px 7px 14px -3px rgba(0,0,0,0.24)",g.tag.style.borderTopLeftRadius="4px",g.tag.style.borderTopRightRadius="4px",g.tag.style.borderBottomLeftRadius="4px",g.tag.style.borderBottomRightRadius="4px",g.tag.style.padding="12px"),y=g.tag,document.getElementsByTagName("body")[0].appendChild(g.tag),r(l,"click",function(a){return f.popUpShow(a)},"popup_")):b+='| "place" ('+c+") not not found";a.size&&
0<a.size&&(w=a.size);a.color?E=a.color:l&&l.value&&(c=M(l.value),E=c.h,D&&(z=c.a));!a.method||"triangle"!=a.method&&"quad"!=a.method||(Y=a.method);fa()||(b+=" | cant init canvas context");b?"undefined"!==typeof console&&console.log("KellyColorPicker : "+b):("quad"==Y&&(x=R()),"triangle"==Y&&(x=O()),l&&(a=function(a){a=a||window.event;a.target||(a.target=a.srcElement);f.setColorByHex(a.target.value,!0)},r(l,"click",a,"input_edit_"),r(l,"change",a,"input_edit_"),r(l,"keyup",a,"input_edit_"),r(l,"keypress",
