...
this.padding;this.size=Math.floor(2*this.outerRadius*Math.sin(H/180*60));var a=Math.sqrt(3)/2*this.size;this.h=Math.sqrt(3)/2*this.size;this.path=[];this.path[0]={x:this.outerRadius,y:0};this.path[1]={x:this.path[0].x-a,y:this.size/2*-1};this.path[2]={x:this.path[1].x,y:this.size/2};this.path[3]={x:this.path[0].x,y:this.path[0].y};for(a=0;a<=this.path.length-1;++a)this.path[a].x+=h.pos.x,this.path[a].y+=h.pos.y;this.vol=[];this.s=this.calcS(this.path);this.sOnTop?(a=ka(this.path[0],this.path[2]),
...
b.x)/2,y:(a.y+b.y)/2}}function ja(a,b,c){b||(b={x:0,y:0});a=180*Math.atan2(a.y-b.y,a.x-b.x)/H;c&&0>a&&(a=360+a);return a}function ea(){ma=2+x.paddingX;L=!1;h.imageData=null;J=u/2;h.pos={x:J,y:J};h.outerRadius=J-ma;h.innerRadius=h.outerRadius-h.width;x.path=[{x:h.innerRadius-x.paddingX,y:-1*x.height},{x:h.outerRadius+x.paddingX,y:-1*x.height},{x:h.outerRadius+x.paddingX,y:x.height},{x:h.innerRadius-x.paddingX,y:x.height},{x:h.innerRadius-x.paddingX,y:-1*x.height}];var a=u;D&&(a+=r.width+2*r.padding);
"CANVAS"!=E.tagName&&(E.style.width=a+"px",E.style.height=u+"px");n.width=a;n.height=u;P!=n&&(n.style.width=a+"px",n.style.height=u+"px");for(a=0;a<=k.length-1;++a)k[a].updateSize();w&&(w.imageData.triangle=null,w.imageData.quad=null,w.updateSize());y.updateSize();D&&r.updateSize()}function W(a){if(t&&(!l.updateinput||(0,l.updateinput)(g,t,a))){var b="rgba("+F.r+", "+F.g+", "+F.b+", "+G.toFixed(2)+")";a||(t.value=1>G&&"mixed"===aa?b:"hex"===aa||"mixed"===aa?I:b);na&&(t.style.color=.5>m.v?"#FFF":"#000",
t.style.background=b)}}function ta(){if(!E)return!1;"CANVAS"!=E.tagName?(n=document.createElement("CANVAS"),E.appendChild(n)):n=E;"undefined"!=typeof window.G_vmlCanvasManager&&(n=window.G_vmlCanvasManager.initElement(n),v=window.G_vmlCanvasManager.initElement(v));return n.getContext&&n.getContext("2d")?(e=n.getContext("2d"),f=v.getContext("2d"),!0):!1}function ba(){z(n,"mousedown",function(a){g.mouseDownEvent(a)},"wait_action_");z(n,"touchstart",function(a){g.mouseDownEvent(a)},"wait_action_");z(n,
...
k[a]);d||!1===b||(k[b].selected=!0);return d}function fa(){for(var a=0;a<=k.length-1;++a)k[a].selected&&(k[a].color=I)}function qa(){if(k.length)for(var a=0;a<=k.length-1;++a)k[a].draw()}function ua(){if(!e)return!1;e.clearRect(0,0,n.width,n.height);if(L)return e.putImageData(X,0,0),qa(),!0;h.draw();y.draw();D&&r.draw();qa();w&&w.draw();A||(X=e.getImageData(0,0,n.width,n.height),L=!0);return!0}function M(){if(!ua())return!1;var a=360*m.h-h.startAngle;D&&(e.beginPath(),e.rect(r.pos.x-2,r.padding+r.height*
(1-G)-1,r.width+4,2),e.strokeStyle="rgba(0,0,0, 0.8)",e.lineWidth=2,e.stroke(),e.closePath());e.beginPath();var b=x.path,c;c=H/180*a;for(var a=[],d=0;d<=b.length-1;++d)a[d]={x:b[d].x*Math.cos(c)-b[d].y*Math.sin(c),y:b[d].x*Math.sin(c)+b[d].y*Math.cos(c)};for(b=0;b<=a.length-1;++b)a[b].x+=h.pos.x,a[b].y+=h.pos.y,0==b?e.moveTo(a[b].x,a[b].y):e.lineTo(a[b].x,a[b].y);e.strokeStyle="rgba(0,0,0,0.8)";e.lineWidth=x.lineWeight;e.stroke();e.closePath();e.strokeStyle=.5<m.v&&.5>m.s?"rgba(0, 0, 0, 1)":"rgba(255, 255, 255, 1)";
e.beginPath();e.lineWidth=2;e.arc(m.x,m.y,ra.radius,0,2*H);e.stroke();e.closePath();return!1}var H=Math.PI,y,sa=!0,ra={radius:4},n=!1,e=!1,B="quad",D=!1,A=!1,K=!0,O=[],l=[],v=document.createElement("canvas"),f=!1,L=!1,X=null,t=!1,na=!0,aa="mixed",p={tag:!1,margin:6},E=!1,g=this,ma,u=200,J,m,F,I="#000000",G=1,P=!1,Z=!1,k=[],w=!1,T=[],h={width:18,imageData:null};h.innerRadius;h.startAngle=0;h.outerRadius;h.outerStrokeStyle="rgba(0,0,0,0.2)";h.innerStrokeStyle="rgba(0,0,0,0.2)";h.pos;h.draw=function(){if(this.imageData)e.putImageData(this.imageData,
0,0);else{for(var a=this.startAngle,b=0;360>=b;b++){var c=H/180*(b-2),d=H/180*b;e.beginPath();e.moveTo(J,J);e.arc(J,J,this.outerRadius,c,d,!1);e.closePath();c=U(a/360,1,1);e.fillStyle="rgb("+c.r+", "+c.g+", "+c.b+")";e.fill();a++;360<=a&&(a=0)}e.globalCompositeOperation="destination-out";e.beginPath();e.arc(J,J,this.innerRadius,0,2*H);e.fill();e.globalCompositeOperation="source-over";e.strokeStyle=this.innerStrokeStyle;e.lineWidth=2;e.stroke();e.closePath();e.beginPath();e.arc(J,J,this.outerRadius,
0,2*H);e.strokeStyle=this.outerStrokeStyle;e.lineWidth=2;e.stroke();e.closePath();this.imageData=e.getImageData(0,0,u,u)}};h.isDotIn=function(a){return Math.pow(this.pos.x-a.x,2)+Math.pow(this.pos.y-a.y,2)<Math.pow(this.outerRadius,2)&&Math.pow(this.pos.x-a.x,2)+Math.pow(this.pos.y-a.y,2)>Math.pow(this.innerRadius,2)?!0:!1};var x={lineWeight:2,height:4,paddingX:2};x.path;var r={width:18,padding:4,outerStrokeStyle:"rgba(0,0,0,0.2)",innerStrokeStyle:"rgba(0,0,0,0.2)"};r.height;r.pos;r.updateSize=function(){this.pos=
...
r.alphaToDot=function(a){return{x:0,y:this.height-this.height*a}};r.limitDotPosition=function(a){a=a.y;a<this.pos.y&&(a=this.pos.y);a>this.pos.y+this.height&&(a=this.pos.y+this.height);return{x:this.pos.x,y:a}};r.isDotIn=function(a){return a.x<this.pos.x||a.x>this.pos.x+r.width||a.y<this.pos.y||a.y>this.pos.y+this.height?!1:!0};var C={svCursorData:null,stCursor:null,curType:0,size:16};C.cEl=document.body;C.initSvCursor=function(){if(!n)return!1;this.curType=1;this.stCursor||(this.stCursor=window.getComputedStyle(this.cEl).cursor,
this.stCursor||(this.stCursor="auto"));if(this.svCursorData)return this.cEl.style.cursor=this.svCursorData,!0;if(!v)return!1;var a=this.size+2;v.width=a;v.height=a;f.clearRect(0,0,this.size,this.size);f.strokeStyle="rgba(255, 255, 255, 1)";f.beginPath();f.lineWidth=2;f.arc(a/2,a/2,this.size/2,0,2*H);f.stroke();f.closePath();var b=v.toDataURL();this.svCursorData="url("+b+") "+a/2+" "+a/2+", auto";if(!this.svCursorData)return!1;this.cEl.style.cursor=this.svCursorData;-1===this.cEl.style.cursor.indexOf(b)&&
(this.svCursorData="crosshair",this.cEl.style.cursor="crosshair");return!0};C.initStandartCursor=function(){this.stCursor&&(C.curType=0,this.cEl.style.cursor=this.stCursor)};C.updateCursor=function(a){sa&&(KellyColorPicker.cursorLock||(y.isDotIn(a)?C.initSvCursor():C.initStandartCursor()))};this.popUpClose=function(a){if(!1!==p.tag){if(a&&(a.target==t||a.target==n||a.target==p.tag))return!1;p.tag.style.display="none";KellyColorPicker.activePopUp==g&&(KellyColorPicker.activePopUp=!1)}};this.popUpShow=
function(a){if(!1!==p.tag&&(!l.popupshow||(0,l.popupshow)(g,a))){KellyColorPicker.popupEventsInclude||(z(document,"click",function(a){return KellyColorPicker.activePopUp?KellyColorPicker.activePopUp.popUpClose(a):!1},"popup_close_"),z(window,"resize",function(a){if(KellyColorPicker.activePopUp)return KellyColorPicker.activePopUp.popUpShow(a)},"popup_resize_"),KellyColorPicker.popupEventsInclude=!0);KellyColorPicker.activePopUp&&KellyColorPicker.activePopUp.popUpClose(!1);a=g.getCanvas().width;var b=
g.getAlphaFig();b&&(a-=b.width+b.padding);b=window.getComputedStyle(p.tag);b=parseInt(b.paddingBottom)+parseInt(b.paddingTop);0>=b&&(b=0);var c=t.getBoundingClientRect(),d=c.left+(window.scrollX||window.pageXOffset||document.body.scrollLeft);p.tag.style.top=c.top+(window.scrollY||window.pageYOffset||document.body.scrollTop)-b-a-p.margin+"px";p.tag.style.left=d+"px";p.tag.style.display="block";KellyColorPicker.activePopUp=g;return!1}};this.setHueByDot=function(a){a=ja(a,h.pos)+h.startAngle;0>a&&(a=
360+a);m.h=a/360;F=U(m.h,m.s,m.v);I=da(F);fa();l.change&&(0,l.change)(g);W();L=!1;M()};this.setColorForColorSaver=function(a,b){var c=N(a,!0);if(c){var d=g.getColorSaver(b);d.selected?this.setColorByHex(a,!1):(d.color=c.h,M());return!0}};this.setColorByHex=function(a,b){b||(b=!1);var c=G;if(!1!==a){if(!a||!a.length)return;var d=N(a,!0);if(!d)return;a=d.h;D&&(c=d.a)}else a=I;D&&a==I&&L&&c!=G?(G=c,M()):I&&a==I&&L||(G=c,F=Y(a),I=a,m=la(F),c=y.svToDot(m),m.x=c.x,m.y=c.y,L=!1,fa(),M(),l.change&&(0,l.change)(g),
W(b))};this.setAlphaByDot=function(a){G=r.dotToAlpha(a);l.change&&(0,l.change)(g);W();M()};this.setAlpha=function(a){G=a;W();M()};this.setColorByDot=function(a){var b=y.dotToSv(a);m.s=b.s;m.v=b.v;m.x=a.x;m.y=a.y;1<m.s&&(m.s=1);0>m.s&&(m.s=0);1<m.v&&(m.v=1);0>m.v&&(m.v=0);F=U(m.h,m.s,m.v);I=da(F);fa();l.change&&(0,l.change)(g);W();M()};this.mouseOutEvent=function(a){0<C.curType&&!KellyColorPicker.cursorLock&&C.initStandartCursor()};this.mouseMoveRest=function(a){if(!A&&K){K=!1;var b=Q(a);C.updateCursor(b);
requestAnimationFrame(function(){K=!0});l.mousemoverest&&(0,l.mousemoverest)(a,g,b)}};this.touchMoveEvent=function(a){A&&event.preventDefault()};this.mouseDownEvent=function(a){a.preventDefault();var b,c=!1,d=Q(a);if(h.isDotIn(d))A="wheel",g.setHueByDot(d),b=function(a){g.wheelMouseMove(a,d)},c=function(a){KellyColorPicker.cursorLock=!1;g.wheelMouseUp(a,d)};else if(y.isDotIn(d))A="sv",g.setColorByDot(d),b=function(a){g.svMouseMove(a,d)},c=function(a){KellyColorPicker.cursorLock=!1;g.svMouseUp(a,d)};
else if(D&&r.isDotIn(d))A="alpha",g.setAlphaByDot(d),b=function(a){g.alphaMouseMove(a,d)},c=function(a){KellyColorPicker.cursorLock=!1;g.alphaMouseUp(a,d)};else if(w&&w.isDotIn(d))g.setMethod();else if(k.length)for(a=0;a<=k.length-1;++a)if(k[a].isDotIn(d)){pa(a);break}b&&c&&(oa(),KellyColorPicker.cursorLock=g,z(document,"mouseup",c,"action_process_"),z(document,"mousemove",b,"action_process_"),z(document,"touchend",c,"action_process_"),z(document,"touchmove",b,"action_process_"))};this.wheelMouseMove=
function(a,b){a.preventDefault();if(A&&K){K=!1;var c=Q(a);requestAnimationFrame(function(){K=!0});g.setHueByDot(c);l.mousemoveh&&(0,l.mousemoveh)(a,g,c)}};this.wheelMouseUp=function(a,b){a.preventDefault();if(A){q(document,"mouseup","action_process_");q(document,"mousemove","action_process_");q(document,"touchend","action_process_");q(document,"touchmove","action_process_");ba();L=A=!1;M();var c=Q(a);C.updateCursor(c);l.mouseuph&&(0,l.mouseuph)(a,g,c)}};this.alphaMouseMove=function(a,b){a.preventDefault();
if(A&&K){K=!1;var c=Q(a),c=r.limitDotPosition(c);requestAnimationFrame(function(){K=!0});g.setAlphaByDot(c);l.mousemovealpha&&(0,l.mousemovealpha)(a,g,c)}};this.alphaMouseUp=function(a,b){a.preventDefault();if(A){q(document,"mouseup","action_process_");q(document,"mousemove","action_process_");q(document,"touchend","action_process_");q(document,"touchmove","action_process_");ba();A=!1;var c=Q(a);C.updateCursor(c);l.mouseupalpha&&(0,l.mouseupalpha)(a,g,c)}};this.svMouseMove=function(a,b){a.preventDefault();
if(A&&K){K=!1;var c=Q(a),c=y.limitDotPosition(c);requestAnimationFrame(function(){K=!0});g.setColorByDot(c);l.mousemovesv&&(0,l.mousemovesv)(a,g,c)}};this.svMouseUp=function(a,b){a.preventDefault();if(A){q(document,"mouseup","action_process_");q(document,"mousemove","action_process_");q(document,"touchend","action_process_");q(document,"touchmove","action_process_");ba();A=!1;var c=Q(a);C.updateCursor(c);D&&(L=!1,M());l.mouseupsv&&(0,l.mouseupsv)(a,g,c)}};this.addUserEvent=function(a,b){l[a]=b;return!0};
this.removeUserEvent=function(a){if(!l[a])return!1;l[a]=null;return!0};this.getCanvas=function(){return e?n:!1};this.getCtx=function(){return e?e:!1};this.getInput=function(){return t};this.getSvFig=function(){return y};this.getSvFigCursor=function(){return ra};this.getWheel=function(){return h};this.getWheelCursor=function(){return x};this.getCurColorHsv=function(){return m};this.getCurColorRgb=function(){return F};this.getCurColorHex=function(){return I};this.getCurColorRgba=function(){return{r:F.r,
g:F.g,b:F.b,a:G}};this.getCurAlpha=function(){return G};this.getAlphaFig=function(){return D?r:!1};this.getPopup=function(){return p};this.getSize=function(){return u};this.getColorSaver=function(a){for(var b=0;b<=k.length-1;++b)if(!a&&k[b].selected||k[b].align==a)return k[b].rgb=Y(k[b].color),k[b].hsv=la(k[b].rgb.r,k[b].rgb.g,k[b].rgb.b),k[b]};this.setColorSaver=function(a){if(!a)return!1;for(var b=0;b<=k.length-1;++b)if(k[b].align==a)return pa(b),k[b]};this.updateView=function(a){if(!e)return!1;
a&&(h.imageData=null,X=y.imageData=null);L=!1;ea();M();return!0};this.resize=function(a,b){if(!e)return!1;if(a==u&&!b)return!0;L=!1;h.imageData=null;X=y.imageData=null;u=a;ea();g.setColorByHex(!1);return!1};this.syncSize=function(a){if(!P)return!1;(a=R(P))&&g.resize(a);return!1};this.setMethod=function(a){a||(a="triangle","triangle"==B&&(a="quad"));if(a==B||"quad"!=B&&"triangle"!=B)return!1;B=a;"quad"==B&&(y=ha());"triangle"==B&&(y=ia());g.resize(u,!0);l.setmethod&&(0,l.setmethod)(g,B);return!0};
this.destroy=function(){if(!g)return!1;0<C.curType&&(KellyColorPicker.cursorLock=!1,C.initStandartCursor());A&&(q(document,"mouseup","action_process_"),q(document,"mousemove","action_process_"),q(document,"touchend","action_process_"),q(document,"touchmove","action_process_"),A=!1);p.tag&&q(t,"click","popup_");t&&(q(t,"click","input_edit_"),q(t,"change","input_edit_"),q(t,"keyup","input_edit_"),q(t,"keypress","input_edit_"));KellyColorPicker.popupEventsInclude&&O.popup_close_click&&(KellyColorPicker.activePopUp&&
KellyColorPicker.activePopUp.popUpClose(!1),q(document,"click","popup_close_"),q(window,"resize","popup_resize_"),KellyColorPicker.popupEventsInclude=!1);h.imageData=null;v=X=y.imageData=null;E&&E.parentNode&&E.parentNode.removeChild(E);P&&q(window,"resize","canvas_");oa();g=null};(function(a){var b="",c="";void 0!==a.alpha_slider&&(a.alphaSlider=a.alpha_slider);void 0!==a.input_color&&(a.inputColor=a.input_color);void 0!==a.input_format&&(a.inputFormat=a.input_format);a.input&&"object"!==typeof a.input?
(a.input=document.getElementById(a.input),t=a.input):"object"===typeof a.input&&(t=a.input);void 0!==a.changeCursor&&(sa=a.changeCursor);void 0!==a.alpha&&(G=a.alpha);void 0!==a.alphaSlider&&(D=a.alphaSlider);void 0!==a.inputColor&&(na=a.inputColor);void 0!==a.inputFormat&&(aa=a.inputFormat);a.userEvents&&(l=a.userEvents);a.place&&"object"!==typeof a.place&&(c=a.place,a.place=document.getElementById(a.place));a.place?E=a.place:t?(p.tag=document.createElement("div"),p.tag.className="popup-kelly-color",
...
"12px",p.tag.style.boxSizing="content-box"),E=p.tag,document.getElementsByTagName("body")[0].appendChild(p.tag),z(t,"click",function(a){return g.popUpShow(a)},"popup_")):b+='| "place" ('+c+") not not found";c=!1;a.color?c=N(a.color):t&&t.value&&(c=N(t.value));c&&(I=c.h,D&&(G=c.a));!a.method||"triangle"!=a.method&&"quad"!=a.method||(B=a.method);ta()||(b+=" | cant init canvas context");a.resizeWith&&("object"!==typeof a.resizeWith&&"boolean"!==typeof a.resizeWith&&(a.resizeWith=document.getElementById(a.resizeWith)),
P=!0===a.resizeWith?n:a.resizeWith,a.resizeSide&&(Z=a.resizeSide),P&&(R(P)&&(a.size=R(P)),z(window,"resize",function(a){return g.syncSize(a)},"canvas_")));a.size&&0<a.size&&(u=a.size);b?"undefined"!==typeof console&&console.log("KellyColorPicker : "+b):("quad"==B&&(y=ha()),"triangle"==B&&(y=ia()),t&&(b=function(a){a=a||window.event;a.target||(a.target=a.srcElement);g.setColorByHex(a.target.value,!0)},z(t,"click",b,"input_edit_"),z(t,"change",b,"input_edit_"),z(t,"keyup",b,"input_edit_"),z(t,"keypress",
b,"input_edit_")),a.colorSaver&&(V("left",!0),V("right")),a.methodSwitch&&S(),ba(),ea(),g.setColorByHex(!1))})(ca)}KellyColorPicker.cursorLock=!1;KellyColorPicker.activePopUp=!1;KellyColorPicker.popupEventsInclude=!1;KellyColorPicker.attachToInputByClass=function(ca,S){for(var V=[],R=document.getElementsByClassName(ca),N=0;N<R.length;N++)S?S.input=R[N]:S={input:R[N],size:150},V.push(new KellyColorPicker(S));return V};
